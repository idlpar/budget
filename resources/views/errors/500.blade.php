...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-900">
        <div class="bg-white dark:bg-slate-700 shadow-lg rounded-lg p-8 max-w-md w-full text-center">
            ...
            <h1 class="text-4xl font-bold text-slate-800 dark:text-slate-200 mb-4">500 - Server Error</h1>
            <p class="text-slate-600 dark:text-slate-400 mb-6">Something went wrong on our end. Please try again later.</p>
