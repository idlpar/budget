        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-6">
                @auth
                    ...
                    <div class="relative" x-data="{ userOpen: false }" @click.away="userOpen = false">
                        ...
                        <div x-show="userOpen" class="origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-xl bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 transform transition-all duration-300 ease-out" x-cloak>
                            ...
                            @if (auth()->user()->isAdmin())
                                <a href="{{ route('register') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-indigo-100 dark:hover:bg-indigo-900 hover:text-indigo-900 dark:hover:text-indigo-300 rounded-lg">Register User</a>
                            @endif
                ...
                @else
                    ...
                    <a href="{{ route('password.request') }}" class="text-white hover:text-emerald-300 hover:scale-105 transition-all duration-200 px-3 py-2 rounded-md text-sm font-medium">Forgot Password</a>
                @endauth
            </div>

            <!-- Mobile Menu Button -->
            <div class="flex items-center lg:hidden">
                <button type="button" class="p-2 rounded-md text-white hover:text-emerald-300 hover:bg-indigo-900 focus:outline-none" id="mobile-menu-button" aria-controls="sidebar" aria-expanded="false">
